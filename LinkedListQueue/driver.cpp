...
void perform(char ans, int &que, LinkedListQueue<string> &one, LinkedListQueue<string> &two)
{
   string item;
   bool repeat;
   char filename[80];
   ...
   case 'M' : cout<<"Putting two into one.";
       ...
       cout<<"The contents of queue two are: "<<endl<<two<<endl<<endl;
       break;
   case 'C' : cout<<"One is a copy of two."<<endl;
       one = two;
       cout<<"The contents of queue one are: "<<endl<<one<<endl<<endl;
       cout<<"The contents of queue two are: "<<endl<<two<<endl<<endl;
       break;
...
void loadfile(LinkedListQueue<string> &one, char *filename)
{
   ifstream in;
   in.open(filename);
   if(in.fail())
...
void checkArgs(int argc, char *argv[], LinkedListQueue<string> &one, LinkedListQueue<string> &two, int &queue)
{
